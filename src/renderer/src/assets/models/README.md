...
| LongCat                  | longcat.svg                                                    |
| MiMo                     | xiaomimimo.svg                                                       |
| Hy / Hunyuan             | hunyuan.svg                                                    |
| GPT / OpenAI reasoning   | openai.svg                                                           |
| Muse Spark / Llama       | meta.svg                                                       |
...
Model icons use monochrome assets, rendered dark in light themes and light in dark themes. Kimi uses an inline theme-aware mark with its blue accent preserved; a monochrome source is also available at `../kimi.svg`.

The user supplied replacement SVGs in Downloads for OpenAI, Anthropic, Gemini, Huawei, Spark, StepFun, Z.ai, Hunyuan, DeepSeek, Doubao, Grok, Meta, Qwen and LongCat. These are copied unchanged into this directory. Huawei / Pangu, Spark, Step / StepFun and Doubao map to `huawei.svg`, `spark.svg`, `stepfun.svg` and `doubao.svg` respectively. Legacy color assets remain on disk but are not used by ModelLogo.
